...
func (in *ClusterPolicySpec) DeepCopyInto(out *ClusterPolicySpec) {
	*out = *in
	...
	in.SandboxedEnvironments.DeepCopyInto(&out.SandboxedEnvironments)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SandboxedEnvironmentsSpec) DeepCopyInto(out *SandboxedEnvironmentsSpec) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SandboxedEnvironmentsSpec.
func (in *SandboxedEnvironmentsSpec) DeepCopy() *SandboxedEnvironmentsSpec {
	if in == nil {
		return nil
	}
	out := new(SandboxedEnvironmentsSpec)
	in.DeepCopyInto(out)
	return out
}
