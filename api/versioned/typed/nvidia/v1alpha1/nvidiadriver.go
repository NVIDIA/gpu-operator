...
func (c *nVIDIADrivers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NVIDIADriver, err error) {
	result = &v1alpha1.NVIDIADriver{}
	err = c.client.Get().
...
func (c *nVIDIADrivers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NVIDIADriverList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NVIDIADriverList{}
	err = c.client.Get().
		Resource("nvidiadrivers").
...
func (c *nVIDIADrivers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *nVIDIADrivers) Create(ctx context.Context, nVIDIADriver *v1alpha1.NVIDIADriver, opts v1.CreateOptions) (result *v1alpha1.NVIDIADriver, err error) {
	result = &v1alpha1.NVIDIADriver{}
	err = c.client.Post().
		Resource("nvidiadrivers").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *nVIDIADrivers) Update(ctx context.Context, nVIDIADriver *v1alpha1.NVIDIADriver, opts v1.UpdateOptions) (result *v1alpha1.NVIDIADriver, err error) {
	result = &v1alpha1.NVIDIADriver{}
	err = c.client.Put().
		Resource("nvidiadrivers").
		Name(nVIDIADriver.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(nVIDIADriver).
		Do(ctx).
		Into(result)
...
func (c *nVIDIADrivers) UpdateStatus(ctx context.Context, nVIDIADriver *v1alpha1.NVIDIADriver, opts v1.UpdateOptions) (result *v1alpha1.NVIDIADriver, err error) {
	result = &v1alpha1.NVIDIADriver{}
	err = c.client.Put().
		Resource("nvidiadrivers").
		Name(nVIDIADriver.Name).
...
func (c *nVIDIADrivers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *nVIDIADrivers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *nVIDIADrivers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NVIDIADriver, err error) {
	result = &v1alpha1.NVIDIADriver{}
