...
// resolve the operand image, build the operand's render data, and render. Per-operand
// behavior is injected through the function fields so each operand file only declares
