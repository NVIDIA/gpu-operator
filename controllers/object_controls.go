...
func isDaemonSetReady(name string, n ClusterPolicyController) gpuv1.State {
	...
	if ds.Spec.UpdateStrategy.Type != appsv1.OnDeleteDaemonSetStrategyType {
		if isRollingUpdateDaemonSetReady(ds) {
			return gpuv1.Ready
		}
		return gpuv1.NotReady
	}
...
// isRollingUpdateDaemonSetReady reports whether a RollingUpdate DaemonSet has observed its latest generation
// and all desired pods are updated and available.
func isRollingUpdateDaemonSetReady(ds *appsv1.DaemonSet) bool {
