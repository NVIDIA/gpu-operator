...
func main() {
	...
	clusterUpgradeStateManager = clusterUpgradeStateManager.
		WithPodDeletionEnabled(gpuPodSpecFilter(mgr.GetAPIReader())).
...
func gpuPodSpecFilter(c client.Reader) func(pod corev1.Pod) bool {
	return func(pod corev1.Pod) bool {
		...
		return controllers.PodHasNVIDIAGPUClaim(context.Background(), c, &pod, false)
	}
}
